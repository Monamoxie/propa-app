    ...
    <body class="antialiased">
        <section class="header">
            <nav class="navbar navbar-expand-lg navbar-light py-lg-2 py-2">
                ...
                <!-- <a class="btn btn-secondary btn-theme" href="find-property.html"><span class="fa fa-search"></span> Add Property</a> -->
                <a class="btn btn-secondary btn-theme" href="/property/load"><span class="fa fa-bank"></span> Load Property</a>
                </div>
            </nav>
        </section>
            ...
            <div class="about-inner portfolo-1">
                <div class="container">
                    <ul class="breadcrumbs-custom-path">
                        ...
                        <li>
                            <span href="/"><span class="fa fa-search" aria-hidden="true" 
                            data-toggle="collapse" href="#collapseSearch" role="button" aria-expanded="false" aria-controls="collapseSearch"></span> 
                            </span>
                        </li>
                    </ul>
                </div>
